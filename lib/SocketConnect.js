 ...
 *  socket连接类
 */
var SocketClinet = /** @class */ (function (_super) {
    ...
    SocketClinet.prototype.listener = function () {
        ...
        this.serverSocket.on('message', function (msg, rinfo) {
            _this.callback()({
                ...
                app: _this,
                encode: coding_1.encode,
                decode: coding_1.decode,
            });
        });
        /**
         *
    ...
    SocketClinet.prototype.send = function (data) {
        ...
        return new Promise(function (s, j) {
            _this.clientSocket.send(data, 0, data.length, _this.serverPort, _this.Host, function (err) {
                if (err) {
                    j(err);
                }
                else {
    ...
    SocketClinet.prototype.callback = function () {
        var fn = this.compose(this.middleWares);
        return function (ctx) {
            fn(ctx).then(function () { return false; }).catch();
        };
    };
    SocketClinet.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.clientSocket) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.closeSocket(this.clientSocket)];
                    case 1:
                        _a.sent();
                        this.clientSocket = null;
                        _a.label = 2;
                    case 2:
                        if (!this.serverSocket) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.closeSocket(this.serverSocket)];
                    case 3:
                        _a.sent();
    ...
    SocketClinet.prototype.closeSocket = function (socket) {
        return new Promise(function (s, j) {
